...
void main() {
  ...
  //declare and initialize variable as input for testing
  ...
  // for testing check if user is first timer
  ...
  group(
    ...
    () {
      blocTest<OnBoardingCubit, OnBoardingState>(
          ...
          act: (cubit) => cubit.cacheIfUserIsFirstTimer(),
          expect: () => const [
      ...
      blocTest<OnBoardingCubit, OnBoardingState>(
        ...
        build: (){
          when(() => checkIfUserIsFirstTimer()).thenAnswer((_) async => const Right(true));
          return cubit;
        },
